...
import {PSQLRC, PSQL_EDITOR_CMD, PsqlController, PsqlErrorParser, PsqlQueryParser,psqlCommandControllerInstance} from "./psql.js";
      ...
      setTimeout(function () {
        ...
        terminal.on('data', function (data) {
          if (data.charCodeAt(0) == 13) {
            ...
            let ys = y - 0;
            ys = (ys < 1) ? 1 : ys;
            let line = terminal.grabText(0, x, ys, y);
            let line_clean = null;
            let m = null;
            let cmd1 = null;
            let cmd2 = null;
            ...
            if (pr && pr > 1) {
              let cmds = queryParser.getQueries();
              queryParser.reset();
