            ...
            "maximumSqlViews":
              {
                ...
                minimum:
                  1,
                description:
                  "The maximum number of sql view tabs before we start removing old ones"
              }
            ,
            "maximumSqlViewInKb":
              {
                ...
                minimum:
                  1,
                description:
                  "The maximum sql view file size in Kb"
              }
            ,
          }
      }
            ...
            "psqlPrompt1Regexp":
              {
                ...
                default:
                  "^‡\\w+:",
                description:
                  "psql PROMPT1 regular expression.  this regexp must match to PROMPT1"
              }
            ,
            "psqlPrompt2Regexp":
              {
                ...
                default:
                  "^‡\\w+\\-",
                description:
                  "psql PROMPT2 regular expression. this regexp must match to PROMPT2"
              }
            ,
            "psqlPagerStopSendCommand":
              {
                ...
                default:
                  "CTRL+C",
                description:
                  "psql character sequence for sending to psql in order to stop the pager"
              }
            ,
            "PROMPT1":
              {
                ...
                default:
                  '‡%/: ',
                description:
                  "psql variable PROMPT1  (needs reload)"
              }
            ,
            "PROMPT2":
              {
                ...
                default:
                  '‡%/- ',
                description:
                  "psql variable PROMPT2 (needs reload)"
              }
            ,
            "PROMPT3":
              {
                ...
                default:
                  '_>> ',
                description:
                  "psql variable PROMPT3 (needs reload)"
              }
            ,
            'terminalInsertDelay':
              {
                ...
                default:
                  400,
                description:
                  "time delay on transfer to terminal, minimum value 200",
              }
            ,
            // "echoFailedCommands": {
            //   type: "boolean",
            //   default: true,
            //   description: 'echo failed commands (--echo-errors) (apply on Reports)',
            // },
            "echoQueries":
              {
                type: "boolean",
                default:
                  true,
                description:
                  'inttial value for echo commands sent to server (--echo-queries) (apply on Reports)',
              }
